...
system("./RStatistics.R $Rpath $Rstatpath $RQpospath");                                       #Start R-Script

##DELETE QPOS FILE
##############################################################################################################
while (!-e $Resultpath."\/Graphical-Results.pdf"){}
if (-e $Resultpath."\/Graphical-Results.pdf"){unlink $Resultpath."Qpos.txt"}
